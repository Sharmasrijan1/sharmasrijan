...
import { SiTailwindcss, SiNginx, SiDocker, SiReact, SiNextdotjs, SiWindows, SiUbuntu, SiDebian, SiSpotify, SiLua, SiApplemusic, SiRazer,SiHey, SiDiscord, SiRoblox, SiSnapchat} from "react-icons/si";
        ...
        <>
            ...
            <div className="min-h-[100vh] bg-gradient-to-br text-[#4c4f69] from-[#eff1f5] to-[#e6e9ef] dark:from-[#12101F] dark:to-[#1E1D2E] dark:text-white">
                <motion.div className="max-w-[64em] ml-auto mr-auto pt-24 pb-48 lg:pt-[10em] px-8" animate={{ opacity: [0, 1], y: [-20, 0] }}>
                    ...
                    <p className="font-['Fira_Sans'] text-[#6c6f85] dark:text-gray-300 text-xl pb-2">So, Yeah...</p>
